...
const translations = {
  en: {
    ...
    svc4_desc: "Optimize your Google Maps button to open your new landing page, generate branded QR table menus, and link your Instagram/Linktree directly to your fast site.",
    svc4_t1: "Google Maps Order", svc4_t2: "Branded QR Menu", svc4_t3: "Instagram/Linktree",
    ...
    faq9_q: "How do you integrate Instagram and Linktree?",
    faq9_a: "We link your Instagram profile bio and Linktree directly to your new landing page, creating a single hub for all customer interactions. One link guides them to your website, services, and social channels.",
  ...
  jp: {
    ...
    svc4_desc: "Googleマップのボタンを最適化して新しいランディングページに誘導し、ブランドQRテーブルメニューを生成し、InstagramとLinktreeを高速サイトと連携させます。",
    svc4_t1: "Googleマップ注文", svc4_t2: "ブランドQRメニュー", svc4_t3: "Instagram/Linktree",
    ...
    faq9_q: "InstagramとLinktreeをどのように統合しますか？",
    faq9_a: "InstagramプロフィールのバイオとLinktreeをあなたの新しいランディングページに直接リンクし、すべての顧客インタクションの一元化ハブを作成します。1つのリンクで顧客をウェブサイト、サービス、ソーシャルチャネルに導きます。",
  ...
  np: {
    ...
    svc4_desc: "हजुरको Google मानचित्र बटनलाई हजुरको नयाँ ल्यान्डिङ पेजमा निर्देशित गर्नुहोस्, ब्र्यान्डेड QR टेबल मेनु उत्पन्न गर्नुहोस्, र हजुरको Instagram/Linktree लाई हजुरको छिटो साइटसँग जोड्नुहोस्।",
    svc4_t1: "Google Maps अर्डर", svc4_t2: "ब्र्यान्डेड QR मेनु", svc4_t3: "Instagram/Linktree",
    ...
    faq9_q: "तपाई Instagram र Linktree लाई कसरी एकीकृत गर्नुहुन्छ?",
    faq9_a: "हामी तपाईंको Instagram प्रोफाइल बायो र Linktree लाई तपाईंको नयाँ ल्यान्डिङ पेजमा सिधै लिङ्क गर्छौं, सबै ग्राहक अन्तरक्रियाको लागि एकल हब बनाइएको। एक लिङ्कले ग्राहकहरूलाई तपाईंको वेबसाइट, सेवा र सोशल च्यानलमा गाइड गर्छ।",
