...
const translations = {
  en: {
    ...
    form_note: "Urgent? Email us at digistartnp@gmail.com and we’ll respond fast.",
  ...
  jp: {
    ...
    form_note: "お急ぎの場合は digistartnp@gmail.com にメールしてください。迅速に対応します。",
    ...
    form_success: "✅ 送信完了！24時間以内にご連絡します。",    email_us: "お急ぎの場合はこちらからメールしてください",    footer_tagline: "スマートに始め、デジタルに始める。デジタルトランスフォーメーションの信頼できるパートナー。",
  ...
  np: {
    ...
    form_note: "तत्काल समस्या छ? digistartnp@gmail.com मा ईमेल गर्नुहोस्, हामी चाँडै जवाफ दिनेछौं।",
    ...
    email_us: "आपतकालीन? कृपया digistartnp@gmail.com मा इमेल गर्नुहोस्",
